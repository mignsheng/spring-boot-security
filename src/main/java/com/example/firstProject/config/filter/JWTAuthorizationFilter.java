package com.example.firstProject.config.filter;

import com.example.firstProject.config.security.SecurityConstants;
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
  ...
  protected void doFilterInternal(
    ...
    System.out.println("=================" + SecurityConstants.TOKEN_HEADER);
